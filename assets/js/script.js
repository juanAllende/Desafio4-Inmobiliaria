...
function renderizarPropiedades(propiedades, contenedorId) {
    ...
    propiedades.forEach(propiedad => {
        ...
        propiedadElement.className = 'col-md-4 mb-4';
        ...
        `;
        contenedor.appendChild(propiedadElement);
    });
}

// Renderizar las propiedades en la página de inicio
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('venta-container')) {
        renderizarPropiedades(propiedades_venta.slice(0, 3), 'venta-container');
    }
    if (document.getElementById('alquiler-container')) {
        renderizarPropiedades(propiedades_alquiler.slice(0, 3), 'alquiler-container');
    }

    // Renderizar todas las propiedades en las páginas específicas
    if (document.getElementById('venta-container')) {
        renderizarPropiedades(propiedades_venta, 'venta-container');
    }
    if (document.getElementById('alquiler-container')) {
        renderizarPropiedades(propiedades_alquiler, 'alquiler-container');
    }
});
